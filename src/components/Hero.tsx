    ...
    <div className="bg-hero bg-cover bg-center flex items-center flex-col top-0">
      ...
      <div className="640p:mt-[10%] 320p:mt-8 h-fit mb-[4rem] flex flex-col items-center w-full">
        ...
        <div className="flex flex-col gap-3 640p:flex-row mb-5">
          <Button className="text-secondary-foreground text-base px-5 py-7 hover:bg-primary-foreground rounded-">
            Find Your Dream Home Now <RiArrowRightUpFill size={20} />
          </Button>
          <Button className="bg-background text-primary-foreground text-base px-5 py-7 hover:bg-primary-foreground hover:text-background">
            View Listings <RiArrowRightUpFill size={20} />
          </Button>
        </div>
