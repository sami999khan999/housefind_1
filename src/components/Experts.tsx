...
const Experts = () => {
  return (
    <div className="640p:flex justify-center">
      <div className="padding-x h-fit">
        <div className="-mb-[16rem] 640p:mb-0  flex flex-col items-center">
          ...
          <div className="flex flex-col 640p:flex-row gap-6 mt-10 w-full">
        ...
        <div className="bg-primary 640p:rounded-[3rem] rounded-[2rem] relative 640p:-bottom-40 -bottom-[20rem] flex flex-col 640p:flex-row justify-between 640p:h-[21rem] overflow-hidden">
