...
const BestFeaturedItems = () => {
  return (
    <div className="bg-hero bg-cover bg-center h-full padding-x py-[6rem] flex flex-col 640p:flex-row gap-6 640p:gap-0 justify-between">
      <div className="flex flex-col items-center 640p:items-start gap-4">
        ...
        <p className="w-fit 640p:w-[25rem] text-background text-center 640p:text-left">
          z At HouseBox, we’re redefining the way peoples find, sell, and invest
